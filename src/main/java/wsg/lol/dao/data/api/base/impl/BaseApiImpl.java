package wsg.lol.dao.data.api.base.impl;
...
import wsg.lol.dao.data.config.ApiConfig;
...
public class BaseApiImpl implements BaseApi {
    ...
    @Override
    public <Q extends QueryDto, T extends Serializable> T getObject(String apiRef, Map<String, Object> pathParams,
    ...
    @Override
    public <T extends Serializable> T getObject(String apiRef, Map<String, Object> pathParams, Class<T> clazz) {
        String jsonStr = getJSONString(apiRef, pathParams, new HashMap<>());
        return JSON.parseObject(jsonStr, clazz);
    }

    @Override
    public <T extends Serializable> T getObject(String apiRef, Class<T> clazz) {
        return getObject(apiRef, new HashMap<>(), clazz);
    }

    @Override
    public <T extends Serializable> List<T> getArray(String apiRef, Class<T> clazz) {
        return getArray(apiRef, new HashMap<>(), clazz);
    }

    @Override
    public <T extends Serializable> List<T> getArray(String apiRef, Map<String, Object> pathParams, Class<T> clazz) {
        String jsonStr = getJSONString(apiRef, pathParams, new HashMap<>());
