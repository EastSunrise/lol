...
public class LeagueEntryDo extends LeagueEntryDoKey {
    ...
    public String getSeriesProgress() {
        return seriesProgress;
    }

    public void setSeriesProgress(String seriesProgress) {
        this.seriesProgress = seriesProgress == null ? null : seriesProgress.trim();
    }
}