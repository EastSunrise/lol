...
public class PostProviderRegistrationDto extends QueryDto {
     ...
     * The URL must be well-formed, use the http or https protocol, and use the default port for
     * the protocol (http URLs must use port 80, https URLs must use port 443).
     */
    private String url;
