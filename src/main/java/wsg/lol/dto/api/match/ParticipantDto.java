...
public class ParticipantDto {
    ...
    /**
     * Highest ranked tier achieved for the previous season in a specific subset of queueIds,
     * if any, otherwise null. Used to display border in game loading screen. Please refer to the
