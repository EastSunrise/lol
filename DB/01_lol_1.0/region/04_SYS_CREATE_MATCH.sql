...
(
    ...
    game_duration  int         null comment '时长，单位：ms',
...
(
    ...
    total_damage_dealt                  int     null comment '总伤害',
    magic_damage_dealt                  int     null comment '魔法伤害',
    physical_damage_dealt               int     null comment '物理伤害',
    true_damage_dealt                   int     null comment '真实伤害',
    largest_critical_strike             int     null comment '？？？',
    total_damage_dealt_to_champions     int     null comment '对英雄的伤害',
    magic_damage_dealt_to_champions     int     null comment '对英雄的魔法伤害',
    physical_damage_dealt_to_champions  int     null comment '对英雄的物理伤害',
    true_damage_dealt_to_champions      int     null comment '对英雄的真实伤害',
    total_heal                          int     null comment '总治疗',
    total_units_healed                  int     null comment '治疗单位数',
    damage_self_mitigated               int     null comment '自我缓和伤害',
    damage_dealt_to_objectives          int     null comment '对中立生物伤害',
    damage_dealt_to_turrets             int     null comment '对塔的伤害',
    vision_score                        int     null comment '视野得分',
    ...
    total_damage_taken                  int     null comment '承受伤害',
    magical_damage_taken                int     null comment '承受魔法伤害',
    physical_damage_taken               int     null comment '承受物理伤害',
    true_damage_taken                   int     null comment '承受真实伤害',
    ...
    time_c_cing_others                  int     null comment '？？？',
