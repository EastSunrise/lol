...
(
  ...
  TEAM_ID                      CHAR(3) COMMENT '100 for blue side. 200 for red side.',
  LANE                         CHAR(2) COMMENT '分路',
  ROLE                         CHAR(2) COMMENT '角色',
  SPELL1_ID                    VARCHAR(32) COMMENT '召唤师技能ID',
  SPELL2_ID                    VARCHAR(32) COMMENT '召唤师技能ID',
  HIGHEST_ACHIEVED_SEASON_TIER CHAR(2) COMMENT '赛季最高段位',
  -- wsg TIMELINE, STAT
